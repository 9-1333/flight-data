...
### 가설: 엔진 개수가 많을수록, <br> 좌석수가 많아질 것이다

## 1️⃣​ 엔진 개수`engines`별<br> 평균 좌석수`seats` 확인하기 {data-background-image="assets/bg.png"}
...
## 2️⃣​ 박스플롯으로 분포 확인 {data-background-image="assets/bg.png"}
...
## 2️⃣-2​ 박스플롯에 스캐터플롯 추가 {data-background-image="assets/bg.png"}
...
## 2️⃣-3​ 박스플롯, 스캐터플롯 해석 {data-background-image="assets/bg.png"}
::::: columns
...
- 데이터 개수가 너무 적어서 <br> 사분위수를 나누기 어려움
- 중앙값(50%)가 12명, <br> 75%는 379명, 평균은 169명
- 데이터가 극단적으로 나뉘어 있음 (12명 vs. 379명)
...
- 박스가 예상보다 아래쪽에 위치해있음 (0~100명)
- 일부 이상치(378명, 450명)가 따로 표시됨
- 50%가 2명 항공기이고, 102명 항공기가 나머지 25% 차지
...
## 3️⃣​ 왜 예상과 다를까? {data-background-image="assets/bg.png"}
